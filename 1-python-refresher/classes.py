...
class Person:
    def __init__(self, name, age):
        self.__person_name = name  # private attr
        self.__person_age = age  # private attr
...
bob.birthday()
print(bob.getAge())  # prints 33


# CLASSES PRACTICE
# Exercise 1

# Now let's assume that the current month is April,
...
# Complete the function get_april_birthdays(people). This function should return a dictionary with each name of your
# friend with an April birthday as a key, and their updated age as the value.
# Complete the function get_most_common_month(people). This function should return the name of the month with
# the most number of birthdays among your friends.

# There is some testing code provided in test(), and there are more specific
# TODO instructions in each of the two functions mentioned.
